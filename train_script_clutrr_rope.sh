#!/bin/bash
# LoFiT-RoPE training script for CLUTRR (relational reasoning)
...
CUDA_VISIBLE_DEVICES=0 python lofit_trainer.py \
    ...
    --lr 5e-4 --train_batch 4 --num_epoch 5 \
    ...
    --applied_module attention --save_strategy no --l1_lambda 5e-3 \
    --eval_batch 16 --train_size 300 --seed $seed;

# --- Step 2a: RoPE-only ---
echo "=== ${model_name}: Step 2a RoPE-only ===";
CUDA_VISIBLE_DEVICES=0 python lofit_trainer.py \
    --task $task --base_model_name $model_name --apply_chat_template False \
    --ft_method lofit --lofit_component rope --use_topk_heads 32 \
    ...
    --run_mode train --output_file_name "./finetuned_outputs/${task}/${model_name}_${task}_rope_seed${seed}" \
    --applied_module attention --save_strategy no --l1_lambda 0 \
    --rope_reg_alpha 1e-2 --rope_reg_beta 1e-2 --eval_batch 16 --train_size 300 --seed $seed;

# --- Step 2b: v_rope combined ---
echo "=== ${model_name}: Step 2b v_rope ===";
CUDA_VISIBLE_DEVICES=0 python lofit_trainer.py \
    --task $task --base_model_name $model_name --apply_chat_template False \
    --ft_method lofit --lofit_component v_rope --use_topk_heads 32 \
    --lofit_heads "./top_heads/${model_name}_${task}_Aonly_top160heads_${seed}.npy" \
    --lr 1e-2 --train_batch 4 --num_epoch 5 \
    --output_dir "./finetuned_checkpoints/${task}/${model_name}_${task}_v_rope_seed${seed}" \
    --run_mode train --output_file_name "./finetuned_outputs/${task}/${model_name}_${task}_v_rope_seed${seed}" \
    --applied_module attention --save_strategy no --l1_lambda 0 \
    --rope_reg_alpha 1e-2 --rope_reg_beta 1e-2 --eval_batch 16 --train_size 300 --seed $seed;
...
CUDA_VISIBLE_DEVICES=0 python lofit_trainer.py \
    --task $task --base_model_name $model_name --apply_chat_template False \
    --ft_method lofit --lofit_component v --use_topk_heads 32 \
    --lofit_heads "./top_heads/${model_name}_${task}_Aonly_top160heads_${seed}.npy" \
    --lr 1e-2 --train_batch 4 --num_epoch 5 \
    --output_dir "./finetuned_checkpoints/${task}/${model_name}_${task}_v_seed${seed}" \
    --run_mode train --output_file_name "./finetuned_outputs/${task}/${model_name}_${task}_v_seed${seed}" \
    --applied_module attention --save_strategy no --l1_lambda 0 \
    --eval_batch 16 --train_size 300 --seed $seed;
...
#     --task $task --base_model_name $model_name --apply_chat_template False \
#     --ft_method lofit --lofit_component A --use_topk_heads 160 \
#     --lr 1e-3 --train_batch 2 --num_epoch 5 \
#     --output_dir "./finetuned_checkpoints/${task}/${model_name}_${task}_Aonly_seed${seed}" \
#     --run_mode train --output_file_name "./finetuned_outputs/${task}/${model_name}_${task}_Aonly_seed${seed}" \
#     --applied_module attention --save_strategy no --l1_lambda 1e-3 \
#     --eval_batch 8 --train_size 300 --seed $seed;
#
# # --- Step 2a: RoPE-only ---
# echo "=== ${model_name}: Step 2a RoPE-only ===";
# CUDA_VISIBLE_DEVICES=0 python lofit_trainer.py \
#     --task $task --base_model_name $model_name --apply_chat_template False \
#     --ft_method lofit --lofit_component rope --use_topk_heads 48 \
#     --lofit_heads "./top_heads/${model_name}_${task}_Aonly_top160heads_${seed}.npy" \
#     --lr 1e-2 --train_batch 2 --num_epoch 5 \
#     --output_dir "./finetuned_checkpoints/${task}/${model_name}_${task}_rope_seed${seed}" \
#     --run_mode train --output_file_name "./finetuned_outputs/${task}/${model_name}_${task}_rope_seed${seed}" \
#     --applied_module attention --save_strategy no --l1_lambda 0 \
#     --rope_reg_alpha 1e-2 --rope_reg_beta 1e-2 --eval_batch 8 --train_size 300 --seed $seed;
#
# # --- Step 2b: v_rope combined ---
# echo "=== ${model_name}: Step 2b v_rope ===";
# CUDA_VISIBLE_DEVICES=0 python lofit_trainer.py \
#     --task $task --base_model_name $model_name --apply_chat_template False \
#     --ft_method lofit --lofit_component v_rope --use_topk_heads 48 \
#     --lofit_heads "./top_heads/${model_name}_${task}_Aonly_top160heads_${seed}.npy" \
#     --lr 1e-2 --train_batch 2 --num_epoch 5 \
#     --output_dir "./finetuned_checkpoints/${task}/${model_name}_${task}_v_rope_seed${seed}" \
#     --run_mode train --output_file_name "./finetuned_outputs/${task}/${model_name}_${task}_v_rope_seed${seed}" \
...
# CUDA_VISIBLE_DEVICES=0 python lofit_trainer.py \
#     --task $task --base_model_name $model_name --apply_chat_template False \
#     --ft_method lofit --lofit_component v --use_topk_heads 48 \
#     --lofit_heads "./top_heads/${model_name}_${task}_Aonly_top160heads_${seed}.npy" \
#     --lr 1e-2 --train_batch 2 --num_epoch 5 \
#     --output_dir "./finetuned_checkpoints/${task}/${model_name}_${task}_v_seed${seed}" \
#     --run_mode train --output_file_name "./finetuned_outputs/${task}/${model_name}_${task}_v_seed${seed}" \
...
# CUDA_VISIBLE_DEVICES=0 python lofit_trainer.py \
#     --task $task --base_model_name $model_name --apply_chat_template False \
#     --ft_method lofit --lofit_component rope --use_topk_heads 16 \
#     --lofit_heads "./top_heads/${model_name}_${task}_Aonly_top160heads_${seed}.npy" \
#     --lr 1e-2 --train_batch 4 --num_epoch 5 \
#     --output_dir "./finetuned_checkpoints/${task}/${model_name}_${task}_rope_seed${seed}" \
#     --run_mode train --output_file_name "./finetuned_outputs/${task}/${model_name}_${task}_rope_seed${seed}" \
...
# CUDA_VISIBLE_DEVICES=0 python lofit_trainer.py \
#     --task $task --base_model_name $model_name --apply_chat_template False \
#     --ft_method lofit --lofit_component v_rope --use_topk_heads 16 \
#     --lofit_heads "./top_heads/${model_name}_${task}_Aonly_top160heads_${seed}.npy" \
#     --lr 1e-2 --train_batch 4 --num_epoch 5 \
#     --output_dir "./finetuned_checkpoints/${task}/${model_name}_${task}_v_rope_seed${seed}" \
#     --run_mode train --output_file_name "./finetuned_outputs/${task}/${model_name}_${task}_v_rope_seed${seed}" \
...
# CUDA_VISIBLE_DEVICES=0 python lofit_trainer.py \
#     --task $task --base_model_name $model_name --apply_chat_template False \
#     --ft_method lofit --lofit_component v --use_topk_heads 16 \
#     --lofit_heads "./top_heads/${model_name}_${task}_Aonly_top160heads_${seed}.npy" \
#     --lr 1e-2 --train_batch 4 --num_epoch 5 \
#     --output_dir "./finetuned_checkpoints/${task}/${model_name}_${task}_v_seed${seed}" \
#     --run_mode train --output_file_name "./finetuned_outputs/${task}/${model_name}_${task}_v_seed${seed}" \
